...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-neutral-950 dark:focus-visible:ring-neutral-300',
  {
    variants: {
      variant: {
        default: 'bg-orange-600 text-neutral-50 hover:bg-orange-600/90 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50/90',
        ...
        'brand-outline': 'border border-orange-600 text-orange-600 hover:border-orange-600/90 dark:border-orange-600 dark:text-orange-600 dark:hover:border-orange-600/90',
        outline: 'border border-neutral-300 hover:border-neutral-900 hover:text-neutral-900 dark:border-orange-500 dark:hover:bg-orange-400 dark:hover:text-orange-400',
